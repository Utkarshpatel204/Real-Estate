    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <div className='flex gap-4'>
                <input onChange={(e)=>setFiles(e.target.files)} type='file' id='images' accept='images/*' multiple className='border border-gray-300 p-3 rounded w-full' />
                <button type='button' onClick={handleImageSubmit} className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80' disabled={uploading}>
